...
class ResearchInnovationOfficerMenu extends StatelessWidget {
  const ResearchInnovationOfficerMenu({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(ResearchOfficerNavigationController());
...
class ResearchOfficerNavigationController extends GetxController {
