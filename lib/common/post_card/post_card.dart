                ...
                child: InkWell(
                  onLongPress: () async {
                    if (GetStorage().read('loggedInUserId') == null) {
                      ...
                      if (GetStorage().read('loggedInUserId') == post.user.id) {
                        postcontroller.showDeleteConfirmationDialog(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                if (post.post.isVideo) {
                                  ...
                                  controller.showLargeImage(post.post.postUrl);
                                }
                              },
                              child: Container(
                                height:
                                ...
                                child: post.post.isVideo
                                    ...
                                    //VideoPlayerFileCustom1(videoUri: post.post.postUrl)
                                    // VideoPlayerFileCustom1(
                                    //   videoUri: post.post.postUrl,)
                                    : Image.network(
                                        post.post.postUrl,
                                        fit: BoxFit.cover,
                                        width:
